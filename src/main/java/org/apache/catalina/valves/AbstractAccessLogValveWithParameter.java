 ...
 *
  * <p>
 * For extended parameter coming from a getParameter() call,
 * it is you responsibility to ensure there are no newline or
 * control characters.
 * </p>
 *
 ...
 * @author rancococ
 */
public abstract class AbstractAccessLogValveWithParameter extends ValveBase implements AccessLog {

    private static final Log log = LogFactory.getLog(AbstractAccessLogValveWithParameter.class);
    ...
    //------------------------------------------------------ Constructor
    public AbstractAccessLogValveWithParameter() {
        super(true);
    }
    ...
    /**
     * Are we doing conditional logging. default null.
     * It is the value of <code>conditionUnlessWithParameter</code> property.
     */
    protected String conditionWithParameter = null;

    /**
     * Are we doing conditional logging. default null.
     * It is the value of <code>conditionIfWithParameter</code> property.
     */
    protected String conditionIfWithParameter = null;
     ...
     * @return the attribute name
     */
    public String getConditionWithParameter() {
     ...
     * @param condition Set to null to log everything
     */
    public void setConditionWithParameter(String condition) {
        this.conditionWithParameter = condition;
    }
     ...
     * @return the attribute name
     */
    public String getConditionUnlessWithParameter() {
        return getConditionWithParameter();
    }
     ...
     * @param condition Set to null to log everything
     */
    public void setConditionUnlessWithParameter(String condition) {
        setConditionWithParameter(condition);
    }
     ...
     * @return the attribute name
     */
    public String getConditionIfWithParameter() {
        return conditionIfWithParameter;
    }
     ...
     * @param condition Set to null to log everything
     */
    public void setConditionIfWithParameter(String condition) {
        this.conditionIfWithParameter = condition;
    }
    ...
    public void log(Request request, Response response, long time) {
        if (!getState().isAvailable() || !getEnabled() || logElements == null
                ...
                || conditionWithParameter != null
                && null != request.getRequest().getParameter(conditionWithParameter)
                || conditionIfWithParameter != null
                && null == request.getRequest().getParameter(conditionIfWithParameter)) {
            return;
        }
