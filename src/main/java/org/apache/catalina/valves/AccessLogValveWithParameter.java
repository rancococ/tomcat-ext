 ...
 * </p>
 */
public class AccessLogValveWithParameter extends AbstractAccessLogValveWithParameter {

    private static final Log log = LogFactory.getLog(AccessLogValveWithParameter.class);

    //------------------------------------------------------ Constructor
    public AccessLogValveWithParameter() {
        super();
    }
